      ...
      <div class="container mx-auto xl py-20 px-4 sm:px-0">
        <div class="flex justify-between w-full">
          <a href="<?= get_bloginfo('url') ?>">
            <img class="footer-logo" src="<?= get_bloginfo('template_url') ?>/assets/img/logos/medallia.svg" alt="<?= get_bloginfo('name') ?>">
          </a>
        ...
        <!-- Copyright area -->
         <div class="w-full copyrights mt-10">
          <div class="top-copy flex gap-5 md:gap-10 flex-col md:flex-row">
            <div>Copyright © 2024. Medallia Inc. All rights reserved. </div>
            <div class="terms-nav">
